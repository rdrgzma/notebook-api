class ContactsController < ApplicationController
  ...
  def index
    ...
    render json: @contacts, include: [:kind, :phones, :address] # root: true, include: [:kind, :phones , :address]
  end

  # GET /contacts/1
  def show
    render json: @contact, include: [:kind, :phones, :address] #, root: true, include: [:kind, :phones, :address]
  end
